...
if __name__ == "__main__":
    ...
    busy_beaver(n)
    flag = "SVUSCG{d@m_g0OD_wOrK_Wo0d_u_aGr33?_7410754}"
    # Find candidate steps that correspond to the number of ones
    #   needed for each character in the flag
    enc = [ random.choice(count1[ord(char)]) for char in flag ]
    print(enc)
